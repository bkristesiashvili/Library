        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AuthoredBooks_Books_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookShelves_Sections_SectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShelvesOfBook", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShelvesOfBook_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShelvesOfBook_BookShelves_BookshelveId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_IdentityNumber_Phone_Email",
                table: "Customers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShelvesOfBook_BookId",
                table: "ShelvesOfBook",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_ShelvesOfBook_BookshelveId",
                table: "ShelvesOfBook",
                column: "BookshelveId");
        }
